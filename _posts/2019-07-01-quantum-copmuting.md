...
E pra que precisamos saber disso ? Bom, na computação tradicional é fácil representar um valor com dois cbits, mas na computação quântica representar um valor com dois qbits é um pouco diferente. Um qbit $\|01>$ é o produto de tensores entre os qbits $\|0>$ e $\|1>$
